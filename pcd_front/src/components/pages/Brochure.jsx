...
import { FaFilePdf, FaFileWord, FaArrowLeft, FaArrowRight } from "react-icons/fa";
...
export default function ServiceDetails() {
  ...
  return (
   <><div className="relative w-full h-[700px]">
                ...
                {faqData.map((item, index) => (
                  <div key={index} className="border rounded-md">
                    <button
                      ...
                      className={`w-full text-left p-4 text-lg font-semibold flex justify-between items-center transition-all duration-300 rounded-md ${openIndex === index ? "bg-green-500 text-black" : "bg-green-500 text-black"} hover:bg-green-700`}
                    >
                      {item.question}
    ...
    </div><ContactSection></ContactSection><ChatBot></ChatBot><Footer></Footer></>
