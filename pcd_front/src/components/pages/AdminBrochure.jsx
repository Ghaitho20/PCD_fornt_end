...
const FAQAndPDFSection = () => {
  ...
  return (
              ...
              {faqs.map((item, index) => (
                <div key={index} className="border rounded-md"> 
                  <button
                    ...
                    className={`w-full text-left p-4 text-lg font-semibold flex justify-between items-center rounded-md bg-gradient-to-r from-blue-500 to-green-500 text-black rounded font-medium hover:from-green-500 hover:to-blue-500 transition`}
                  >
                    {item.question}
    ...
    >
      <div className="flex items-center bg-gradient-to-r from-blue-500 to-green-500 text-black p-2 rounded font-medium hover:from-green-500 hover:to-blue-500 transition">
        <div className="mr-2">
          ...
          <p className="text-xs">{doc.description}</p>
              ...
              <div className="mt-6 space-y-2">
                ...
                <button
                  ...
                  className="mt-2 bg-gradient-to-r from-blue-500 to-green-500 text-white px-4 py-2 rounded font-medium hover:from-green-500 hover:to-blue-500 transition"
                >
