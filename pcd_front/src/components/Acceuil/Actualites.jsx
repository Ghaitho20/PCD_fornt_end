...
const NewsItem = ({ title, date, location, imagePath, description }) => {
    ...
    return (
        ...
        >
            ...
            <button
                onClick={handleConsulterClick}
                className={`mt-4 bg-gradient-to-r from-blue-500 to-green-500 text-white py-2 px-4 rounded font-medium hover:from-green-500 hover:to-blue-500 transition ${showDetails ? 'hidden' : ''}`}
            >
                Voir Plus
            </button>
        </motion.div>
